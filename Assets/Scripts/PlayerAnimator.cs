...
namespace TarodevController {
    ...
    public class PlayerAnimator : MonoBehaviour {
        ...
        private void Start()
        {
            vamp = GetComponentInParent<Vampire>();
        }
        ...
        void Update() {
            ...
            if(_player.Input.X != 0 || _player.Input.y != 0) _anim.SetBool(MovingKey, true);
            else _anim.SetBool(MovingKey, false);
            ...
            if (vamp.raging) _anim.SetBool(RagingKey, true);
            else _anim.SetBool(RagingKey, false);
        }
        ...
        private static readonly int RagingKey = Animator.StringToHash("Raging");
